...
export default function Edit({ dtr, circles }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        dtr_name: dtr.dtr_name,
        dtr_code: dtr.dtr_code ?? '',
        capacity: dtr.capacity ?? '',
        feeder_id: String(dtr.feeder_id ?? ''),
    });

    const fdr = dtr.feeder;
    const sec = fdr?.section;
    ...
    const [hierarchy, setHierarchy] = useState({
        ...
        section_id: String(fdr?.section_id ?? ''),
        village_id: '',
        feeder_id: String(dtr.feeder_id ?? ''),
        dtr_id: '',
    });
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400">
                                    Update DTR <span className="font-medium text-blue-600 dark:text-blue-400">{dtr.dtr_name}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
                            ...
                            >
                                {processing ? 'Updating...' : 'Update DTR'}
                            </Button>
                        </div>
                    </form>
                </div>
